...
df = pd.read_csv("data/freekicks_indirect_only.csv").dropna(subset=["location_x", "location_y", "is_goal"])
...
print("Saved clean heatmap_overlay_in.png")